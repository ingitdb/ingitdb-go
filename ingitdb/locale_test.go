...
func TestApplyLocaleToRead(t *testing.T) {
	...
	cols := map[string]*ColumnDef{
		"title":  {Type: ColumnTypeString, Locale: "en"},
		"titles": {Type: ColumnTypeL10N},
	}
	data := map[string]any{
...
func TestApplyLocaleToRead_EmptyColumns(t *testing.T) {
	...
	result := ApplyLocaleToRead(data, map[string]*ColumnDef{})
...
func TestApplyLocaleToWrite_EmptyColumns(t *testing.T) {
	...
	result := ApplyLocaleToWrite(data, map[string]*ColumnDef{})
