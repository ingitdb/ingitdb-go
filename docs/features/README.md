...
|------------------------------------------------------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| [Validator](validator.md)                   | WIP     | Validates schema & data                                                                                                                            | 
| [Materialized views](materialized-views.md) | pending | Generate a precomputed output dataset from multiple source files using defined filters, joins, and transformation logic for fast reuse and access. | 
